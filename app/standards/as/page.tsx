...
const AS_LIST = [
  ...
  { code: 'AS 4', title: 'Contingencies and Events Occurring After the Balance Sheet Date', slug: 'as-4', status: 'ACTIVE' as const },
  { code: 'AS 5', title: 'Net Profit or Loss for the Period, Prior Period Items and Changes in Accounting Policies', slug: 'as-5', status: 'ACTIVE' as const },
  { code: 'AS 6', title: 'Depreciation Accounting', slug: 'as-6', status: 'ACTIVE' as const },
  { code: 'AS 7', title: 'Construction Contracts', slug: 'as-7', status: 'ACTIVE' as const },
