    ...
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <section id="as-11-translation-of-non-integral" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            13. 39 7 . 39 AS BASED ON ITEMS IMPACTING FINANCIAL STATEMENTS Solution Inventories Non - monetary Trade receivables Monetary Investment in equity shares Non - monetary Property, Plant and Equipment Non - monetary Illustration 2 Exchange Rate per $ Goods purchased on.20X1 for US $ 15,000 ` 75 Exchange rate on.20X1 ` 74 Date of actual payment.20X1 ` 73 You are required to ascertain the loss/gain to be recognized for financial years ended 31 st March, 20X1 and 31 st March, 20X2 as per <strong>AS 11</strong>. Solution As per <strong>AS 11</strong> on ‘The Effects of Changes in Foreign Exchange Rates’, all foreign currency transactions should be recorded by applying the exchange rate on the date of transactions. Thus, goods purchased on.20X1 and corresponding creditors would be recorded at ` 11,25,000 (i.e. $15,000 × ` 75) According to the standard, at the balance sheet date all monetary transactions should be reported using the closing rate. Thus, creditors of US $15,000 on.20X1 will be reported at ` 11,10,000 (i.e. $15,000 × ` 74) and exchange profit of ` 15,000 (i.e. 11,25,000 – 11,10,000) should be credited to Profit and Loss account in the year ended 31 st March, 20X1. On.20X1, creditors of $15,000 is paid at the rate of ` 73. As per <strong>AS 11</strong>, exchange difference on settlement of the account should also be transferred to Profit and Loss account. Therefore, ` 15,000 (i.e. 11,10,000 – 10,95,000) will be credited to Profit and Loss account in the year ended 31 st March, 20X2. <PdfRef page={12} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
