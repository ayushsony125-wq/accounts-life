...
import {
  ...
  judicialCases,
  examCorner,
} from './AS12ExamplesData'

interface AS12ExamplesCustomContentProps {
...
export function AS12ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS12ExamplesCustomContentProps) {
    ...
    <div className="w-full space-y-6 animate-fade-in font-sans">
      ...
      <div className="bg-slate-50 dark:bg-[#181E30] border border-slate-200 dark:border-slate-800 rounded-xl p-6 sm:p-8 space-y-4">
        <h4 className="font-sans font-bold text-xs uppercase tracking-wider text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
          <Info size={14} />
          <span>AS 12 Government Grants Treatment Summary</span>
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-[13px] leading-relaxed">
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
            <span className="font-bold text-blue-600 dark:text-blue-400 block mb-2">Specific Depreciable Asset:</span>
            <p className="text-slate-650 dark:text-gray-400 text-[12px] leading-relaxed">
              **Method 1**: Reduce cost of the asset. Depreciation is charged on net value.<br />
              **Method 2**: Credit to Deferred Income. Amortise to P&amp;L in proportion to depreciation.
            </p>
          </div>
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
            <span className="font-bold text-amber-600 dark:text-amber-400 block mb-2">Promoter\'s Contribution:</span>
            <p className="text-slate-650 dark:text-gray-400 text-[12px] leading-relaxed">
              Credit directly to **Capital Reserve** under Shareholders\' Funds. Refund is debited to Capital Reserve.
            </p>
          </div>
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
            <span className="font-bold text-emerald-600 dark:text-emerald-400 block mb-2">Revenue / Expense Grants:</span>
            <p className="text-slate-650 dark:text-gray-400 text-[12px] leading-relaxed">
              Credit to P&amp;L under "Other Income" or deduct from the related expense in the period of match.
            </p>
          </div>
        </div>
      </div>
