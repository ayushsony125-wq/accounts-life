    ...
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <section id="as-13-forms-of-investments" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ADVANCED ACCOUNTING v v v v 5 . 80 <PdfRef page={3} />
          </p>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 13**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-13-cost-of-investments" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ADVANCED ACCOUNTING v v v v 5 . 82 <PdfRef page={5} />
          </p>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 13**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-13-disclosure" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ADVANCED ACCOUNTING v v v v 5 . 106 ` Sale proceeds of 13,000 shares (13,000 x ` 16.50) 2,14,500 Less : 1% Brokerage (2,145) 2,12,355 Less: Cost of 13,000 shares (1,69,500) Profit on sale 42,855 5. Dividend received on investment held as on 1 st April, 20X1 = 15,000 shares x ` 10 x 20% = ` 30,000 will be transferred to Profit and Loss A/c Dividend received on shares purchased on 1 st June, 20X1 = 5,000 shares x ` 10 x 20% = ` 10,000 will be adjusted to Investment A/c Note: It is presumed that no dividend is received o n bonus shares as bonus shares are declared on 1 st July, 20X1 and divid end pertains to the year ended 31.3.20X1. 6. Calculation of closing value of shares (on average basis) as on 31 st March, 20X2 3,39,000 13,000× 26,000 = ` 1,69,500 1 1 . In the Books of Mr. Z 9% Central Government Bonds (Investment) Account Particulars Nominal Value Interest Principal Particulars Nominal Value Interest Principal 20X1 ` ` ` 20X1 ` ` ` Jan.1 To Balance b/d (W.N.1) 1,20,000 2,700 1,18,000 Mar . 31 By Bank A/c (W.N.3) - 6,300 - Marc h 1 To Bank A/c (W.N.2) 20,000 750 19,600 July 1 By Bank A/c (W.N.4) 50,000 1,125 50,000 July 1 To P&amp;L A/c (W.N.5) - - 833 Sept. 30 By Bank A/c (W.N.6) - 4,050 - Oct. 1 To Bank A/c (150 x 98) 15,000 - 14,700 Nov. 1 By Bank A/c (W.N.7) 30,000 225 29,700 <PdfRef page={29} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ASSETS BASED ACCOUNTING STANDARDS v v v v 5 . 107 5 . 107 Nov. 1 To P&amp;L A/c (W.N.8) - - 200 Dec. 31 By Balance c/d (W.N. 9 &amp; W.N.10) 75,000 1,688 73,633 Dec. 31 To P&amp;L A/c (b.f.) (Transfer) 9,938 1,55,000 13,388 1,53,333 1,55,000 13,388 1,53,333 Working Note: 1. Interest element in opening balance of bonds = 1,20,000 x 9% x 3/12 = ` 2,700 2. Purchase of bonds on 1. 3.20X1 Interest element in purchase of bonds = 200 x 100 x 9% x 5/12 = ` 750 Investment element in purchase of bonds = 200 x 98 = ` 19,600 3. Interest for half - year ended 31 March = 1,400 x 100 x 9% x 6/12 = ` 6,300 4. Sale of bonds on 1.7.20X1 Interest element = 500 x 100 x 9% x 3/12 = ` 1,125 Investment element = 500 x 100 = ` 50,000 5. Profit on sale of bonds on 1.7.20X1 Cost of bonds = (1,18,000/ 1,200) x 500 = ` 49,167 Sale proceeds = ` 50,000 Profit element = ` 833 6. Interest for half - year ended 30 September = 900 x 100 x 9% x 6/12 = ` 4,050 7. Sale of bonds on 1.11.20X1 Interest element = 300 x 100 x 9% x 1/12 = ` 225 Investment element = 300 x 99 = ` 29,700 8. Profit on sale of bonds on 1.11.20X1 Cost of bonds = (1,18,000/ 1,200) x 300 = ` 29,500 Sale proceeds = ` 29,700 Profit element = ` 200 <PdfRef page={30} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ADVANCED ACCOUNTING v v v v 5 . 108 9. Closing value of investment Calculation of closing balance: Nominal value ` Bonds in hand remained in hand at 31 st December 20X1 From original holding (1,20,000 – 50,000 – 30,000) = 40,000 40,000 1,20,000 1,18,000  39,333 Purchased on 1st March 20,000 19,600 Purchased on 1 st October 15,000 14,700 75,000 73,633 10. Interest element in closing balance of bonds = 750 x 100 x 9% x 3/12 = ` 1,688 12 . Investment A/c of Mr. Purohit for the year ending on 31 - 3 - 20X2 (Scrip: 8% Debentures of P Limited) (Interest Payable on 30 th September and 31 st March) Date Particulars Nominal Value Interest Cost Date Particulars Nominal Value Interest Cost ` ` ` ` 1.4.20X1 To Balance b/d 1,20,000 - 1,18,000 30.9.20X1 By Bank (1,300 x 100 x 8% x 6/12) - 5,200 - 1.7.20X1 To Bank (ex - Interest) (W.N.1) 10,000 200 9,898 1.10.20X1 By Bank (W.N.4) 20,000 - 19,800 1.10.20X1 To Profit &amp; Loss A/c (W.N.4) 133 1.2.20X2 By Bank (ex - Interest) (W.N.5) 20,000 533 19,602 <PdfRef page={31} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ASSETS BASED ACCOUNTING STANDARDS v v v v 5 . 109 5 . 109 1.1.20X2 To Bank (ex - Interest) (W.N.2) 5,000 100 4,949 1.2.20X2 By Profit &amp; Loss A/c (W.N.5) 64 31.3.20X2 To Profit &amp; Loss A/c (Bal. fig.) - 9,233 31.3.20X2 By Bank (950 x 100 x 8% x 6/12) - 3,800 - 31.3.20X2 By Balance c/d (W.N.3) 95,000 - 93,514 1,35,000 9,533 1,32,980 1,35,000 9,533 1,32,980 Working Notes: 1. Purchase of debentures on 1.7.20X1 Interest element = 100 x 100 x 8% x 3/12 = ` 200 Investment element = (100 x 98) + [1% (100 x 98)] = ` 9,898 2. Purchase of debentures on 1.1.20X2 Interest element = 50 x 100 x 8% x 3/12 = ` 100 Investment element = {"{"}(50 x 98) + [1%(50 x 98)]{"}"} = ` 4,949 3. Valuation of closing balance as on 31.3.20X2: Market value of 950 Debentures at ` 99 = ` 94,050 Cost of 800 Debentures cost = 1,18,000 x80,000 1,20,000       = 78,667 100 Debentures cost = 9,898 50 Debentures cost = 4,949 93,514 Value at the end = ` 93,514, i.e., whichever is less 4. Profit on sale of debentures as on 1.10.20X1 ` Sales price of debentures (200 x ` 100) 20,000 <PdfRef page={32} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ADVANCED ACCOUNTING v v v v 5 . 110 Less : Brokerage @ 1% (200) 19,800 Less : Cost of Debentures =       x20,000 1,20,000 1,18,000 (19,667) Profit on sale 133 5. Loss on sale of debentures as on 1.2.20X2 ` Sales price of debentures (200 x ` 99) 19,800 Less : Brokerage @ 1% (198) 19,602 Less : Cost of Debentures =       x20,000 1,20,000 1,18,000 <PdfRef page={33} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            (19,666 ) Loss on sale 64 Interest element in sale of investment = 200 x 100 x 8% x 4/12 ` 533 13 . Investment Account in Books of Vijay (Scrip: Equity Shares in X Ltd.) No. Amount No. Amount ` ` 1.4.20X1 22.6.20X1 To Bal b/d To Bank 30,000 5,000 4,50,000 80,000 31.10.20X1 By Bank (dividend on shares acquired on 22.6.20X1) — 10,000 10.8.20X1 To Bonus 5,000 _ 30.9.20X1 To Bank (Rights Shares) 10,000 1,50,000 <PdfRef page={33} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            ASSETS BASED ACCOUNTING STANDARDS v v v v 5 . 111 5 . 111 15.11.20X1 To P&amp;L A/c (Profit 32,000 15.11.20X1 By Bank 20,000 3,00,000 on sale of shares) (Sale of shares) 31.3.20X2 By Bal. c/d 30,000 4,02,000 50,000 7,12,000 50,000 7,12,000 Working Notes: (1) Bonus Shares = (30,000 + 5,000) / 7 = 5,000 shares (2) Right Shares = ( ) 30,000 5,000 5,000 3 8 + +  = 15,000 shares (3) Rights shares sold = 15,000×1/3 = 5,000 shares (4) Dividend received = 30,000×10×20% = ` 60,000 will be taken to P&amp;L statement (5) Dividend on shares purchased on 22.6.20X1 = 5,000×10×20% = ` 10,000 is adjusted to Investment A/c (6) Profit on sale of 20,000 shares = Sales proceeds – Average cost Sales proceeds = ` 3,00,000 Average cost = ( ) 4,50,000 + 80,000 + 1,50,000 - 10,000 × 20,000 50,000 = ` 2,68,000 Profit = ` 3,00,000 – ` 2,68,000= ` 32,000. (7) Cost of shares on 31.3.20X2 ( ) 4,50,000 + 80,000 + 1,50,000 - 10,000 × 30,000 50,000 = ` 4,02,000 (8) Sale of rights amounting ` 10,000 ( ` 2 x 5,000 shares) will not be shown in investment A/c but will directly be taken to P &amp; L statement. 14 . As per <strong>AS 13</strong> (Revised) ‘Accounting for <strong>Investments</strong>’, where long - term investments are reclassified as current investments, transfers are made at the <PdfRef page={34} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
