...
import {
  ...
  judicialCases,
  examCorner,
} from './AS14ExamplesData'

interface AS14ExamplesCustomContentProps {
...
export function AS14ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS14ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 14 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-300 leading-relaxed max-w-3xl">
          Learn accounting for amalgamations, absorption, and reconstruction under AS 14 through solved ICAI illustrations, practical corporate deals, audit observations, and critical exam adjustments.
        </p>
      </div>
