...
import {
  ...
  judicialCases,
  examCorner,
} from './AS17ExamplesData'

interface AS17ExamplesCustomContentProps {
...
export function AS17ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS17ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 17 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn segment reporting under AS 17 through 10% threshold calculations, 75% external revenue checks, corporate asset allocations, and transfer pricing audit implications.
        </p>
      </div>
