...
import {
  ...
  judicialCases,
  examCorner,
} from './AS18ExamplesData'

interface AS18ExamplesCustomContentProps {
...
export function AS18ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS18ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 18 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn related party disclosures under AS 18 through relationship matrices, transaction revaluations, KMP compensation audits, and regulatory observation notes.
        </p>
      </div>
