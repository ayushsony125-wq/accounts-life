...
import {
  ...
  judicialCases,
  examCorner,
} from './AS19ExamplesData'

interface AS19ExamplesCustomContentProps {
...
function CaseStudyCard({
  ...
  const themeMap = {
    ...
    emerald: {
      ...
      number: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-350 border-emerald-200/40 dark:border-emerald-800/40',
...
export function AS19ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS19ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 19 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn leases accounting under AS 19 through lease classification matrices, amortization tables, operating lease straight-lining, residual value adjustments, and sale &amp; leaseback regulatory guidelines.
        </p>
      </div>
