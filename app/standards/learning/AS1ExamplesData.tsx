...
export const icaiIllustrations: CaseStudy[] = [
  // ─── OFFICIAL ICAI ILLUSTRATIONS (From ICAI Study Material) ───────────────
  {
    id: "icai-1",
    ...
    panels: [
      {
        ...
        content: (
          <div>
            ...
            <p><strong>Context:</strong> In the books of M/s Prashant Ltd., the closing inventory as at 31.03.20X2 amounts to <strong>₹1,63,000</strong> on the basis of the FIFO method.</p>
            <p><strong>The Change:</strong> The company decides to change from the <strong>FIFO method</strong> to the <strong>Weighted Average method</strong> for ascertaining the cost of inventory from the year 20X1-X2.</p>
            <p><strong>New Valuation:</strong> On the basis of Weighted Average method, closing inventory as on 31.03.20X2 amounts to <strong>₹1,47,000</strong>.</p>
            <p><strong>Net Realisable Value:</strong> The realisable value of the inventory as on 31.03.20X2 amounts to <strong>₹1,95,000</strong>.</p>
            <p><strong>Issue (ICAI Question):</strong> Discuss the disclosure requirement of change in accounting policy as per AS-1. <PdfRefInline page={9} /></p>
          </div>
        )
      },
      {
        title: "AS 1 Analysis — Disclosure Requirement",
        content: (
          <div>
            <p><strong>Standard Guidance:</strong> As per AS 1 "Disclosure of Accounting Policies", any change in an accounting policy which has a material effect should be disclosed in the financial statements. <PdfRefInline page={9} /> The amount by which any item in the financial statements is affected by such change should also be disclosed to the extent ascertainable. Where such amount is not ascertainable, wholly or in part, the fact should be indicated.</p>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li><strong>Reduction in inventory and profit: ₹16,000</strong></li>
      ...
      {
        title: "ICAI Solution — Draft Note 1 Disclosure",
        content: (
          <div>
    ...
    panels: [
      {
        ...
        content: (
          <div>
            ...
            <p><strong>Background:</strong> Jagannath Ltd. made a rights issue of shares in 20X2. In the offer document to its members, it had projected a <strong>surplus of ₹40 crores</strong> during the accounting year ending 31st March, 20X2.</p>
            <p><strong>Actual Results:</strong> The draft results for the year, prepared on hitherto followed accounting policies, showed a <strong>deficit of ₹10 crores</strong>.</p>
            <p><strong>Board Decision:</strong> The board, in consultation with the managing director, decided to change two accounting treatments: <PdfRefInline page={9} /></p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>Change (i):</strong> Value year-end inventory at <em>works cost</em> (₹50 crores) instead of the hitherto method of valuation at <em>prime cost</em> (₹30 crores).</li>
              <li><strong>Change (ii):</strong> Provide for permanent diminution in the value of investments, which had taken place over the past five years — amount: ₹10 crores.</li>
            </ul>
      ...
      {
        title: "Impact Calculation & AS 1 Analysis",
        content: (
          <div>
            <p><strong>Net Effect of Changes:</strong></p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Change (i): Inventory valued at ₹50 crores instead of ₹30 crores → <strong>Profit increases by ₹20 crores</strong>.</li>
              <li>Change (ii): Provision for diminution in investments of ₹10 crores → <strong>Profit decreases by ₹10 crores</strong>.</li>
              <li>Net Impact: Deficit of ₹10 crores → <strong>Surplus of ₹0 crores</strong> (still short of projected ₹40 crores).</li>
            </ul>
            <p><strong>AS 1 Requirement:</strong> As per AS 1, any change in accounting policies which has a material effect in the current period must be disclosed. The amount by which any item is affected must be stated to the extent ascertainable. <PdfRefInline page={9} /> Both changes are material and must be separately disclosed with their financial impacts.</p>
          </div>
        )
      },
      {
        title: "ICAI Solution — Official Notes on Accounts (Jagannath Ltd.)",
        content: (
          <div>
            <div className="p-3 bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 rounded-xl font-mono text-xs leading-relaxed my-2 whitespace-pre-line text-slate-800 dark:text-slate-200">
    ...
    panels: [
      {
        ...
        content: (
          <div>
            ...
            <p><strong>The Transaction:</strong> XYZ has accepted Inter-Corporate Deposits (ICDs). It is making its best efforts to settle the dues. There were claims at varied rates of interest from lenders, from the due date of ICDs to the date of repayment. <PdfRefInline page={10} /></p>
      ...
      {
        title: "ICAI Solution — Official Conclusion",
        content: (
          <div>
            <div className="p-3 bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 rounded-xl font-mono text-xs leading-relaxed my-2 whitespace-pre-line text-slate-800 dark:text-slate-200">
    ...
    panels: [
      {
        ...
        content: (
          <div>
            ...
            <p><strong>Proposed Change:</strong> The company wants to provide during the year ending 31.3.20X2 based on technical evaluation instead of the 12-month issue pattern. <PdfRefInline page={15} /></p>
      ...
      {
        title: "ICAI Analysis — Policy vs. Estimate Distinction",
        content: (
          <div>
            <p><strong>Official ICAI Answer:</strong></p>
            <p>The accounting policy of a company may require that provision for non-moving inventories should be made. The <em>method</em> of estimating the amount of provision may be changed in case a more prudent estimate can be made. <PdfRefInline page={15} /></p>
            <p><strong>(a) Is it a policy change?</strong> The decision of making provision for non-moving inventories on the basis of <em>technical evaluation</em> does NOT amount to a change in accounting policy. The policy is to make provision for non-moving inventory — that policy is unchanged. Only the method of estimation (the mechanism for arriving at the estimate) has changed. This is a <strong>change in accounting estimate</strong>, not a policy change.</p>
            <p><strong>(b) Materiality test:</strong> Considering the total value of inventory (₹100 lakhs), the change in the amount of required provision from ₹3.5 lakhs to ₹2.5 lakhs (a reduction of ₹1 lakh) is also <em>not material</em> (1% of inventory value).</p>
          </div>
        )
      },
      {
        title: "ICAI Solution — Draft Disclosure Note",
        content: (
          <div>
            <div className="p-3 bg-slate-50 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 rounded-xl font-mono text-xs leading-relaxed my-2 whitespace-pre-line text-slate-800 dark:text-slate-200">
  ...
  // ─── CUSTOM ILLUSTRATIVE EXAMPLES (For Learning Portal) ──────────────────
  {
    id: "1-1",
