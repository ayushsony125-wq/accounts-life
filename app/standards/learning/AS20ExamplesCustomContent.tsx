...
import {
  ...
  judicialCases,
  examCorner,
} from './AS20ExamplesData'

interface AS20ExamplesCustomContentProps {
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {pdfPage && navigateToPdfPage && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs text-red-650 hover:text-red-750 dark:text-red-400 dark:hover:text-red-300 font-bold transition-colors cursor-pointer"
            >
              <FileText size={12} />
...
export function AS20ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS20ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 20 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Earnings Per Share calculations under AS 20. Explore time-weighting formulas, partly paid share participation, retrospective bonus adjustments, Rights issue TERP calculations, and sequential ESOP dilution steps.
        </p>
      </div>
