...
import {
  ...
  judicialCases,
  examCorner,
} from './AS21ExamplesData'

interface AS21ExamplesCustomContentProps {
...
export function AS21ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS21ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 21 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Consolidated Financial Statements under AS 21. Explore Goodwill vs Capital Reserve calculations, minority interest share apportionments, downstream/upstream unrealized profit eliminations, and uniform accounting policies adjustments.
        </p>
      </div>
