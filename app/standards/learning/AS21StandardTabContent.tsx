    ...
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <section id="as-21-accounting-standard-for-consolidated-17" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 38 --- Solution Revalued net assets of Zed Ltd. as on 31st March, 20X1 ` in lakhs ` in lakhs Property, plant and equipment [120 X 120%] 144.0 Investments [55 X 90%] 49.5 Less: 15% Debentures 90.0 Current Liabilities 50.0 (140.0) Equity / Net Worth 138.5 Exe Ltd.’s share of net assets (70% of 138.5) 96.95 Exe Ltd.’s cost of acquisition of shares of Zed Ltd. (` 70 lakhs – ` 7 lakhs*) 63.00 * Total Cost of 70 % Equity of Zed Ltd ` 70 lakhs Purchase Price of each share ` 20 Number of shares purchased [70 lakhs /` 20] 3.5 lakhs Dividend @ 20 % i.e. ` 2 per share ` 7 lakhs Since dividend received is for pre-acquisition period, it has been reduced from the cost of investment in the subsidiary company. Illustration 4 A Ltd. acquired 70% of equity shares of B Ltd. on 1.4.20X1 at cost of ` 10,00,000 when B Ltd. had an equity share capital of ` 10,00,000 and reserves and surplus of ` 80,000. In the four consecutive years, B Ltd. fared badly and suffered losses of ` 2,50,000, ` 4,00,000, ` 5,00,000 and ` 1,20,000 respectively. Thereafter in 20X5- X6, B Ltd. experienced turnaround and registered an annual profit of ` 50,000. In the</li>
            <li>-- PAGE 39 ---</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 21**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
        ...
        <section id="as-21-accounting-standard-for-consolidated-20" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            FINANCIAL STATEMENTS (d) Discharge of Purchase Consideration: Tax at source (` 64.80 lakhs – ` 5.40 lakhs) × 30 100 ` 17.82 lakhs 50% of purchase consideration (net of tax) in cash ` 23.49 lakhs [` (64.80 – 17.82) x 50%] Balance – Unsecured Loan ` 23.49 lakhs 2. Goodwill / Capital Reserve to Variety Ltd. ` in lakhs Less: Reduction in Value of Property, Plant and Equipment (1.75) 98.25 Less: Current Liabilities (20.00) Net Assets of VR Ltd. on Date of Acquisition 78.25 Purchase Consideration: 54% purchased from Foreign Co. 64.80 Investment: 46% existing stake 15.64 (80.44) Illustration 6 A Ltd. acquired 60% shares of B Ltd. @ ` 20 per share. Following is the extract of Balance Sheet of B Ltd.: ` 10,00,000 Equity Shares of ` 10 each 1,00,00,000 10% Debentures 10,00,000 Trade Payables 55,00,000 Property, Plant and Equipment 70,00,000 <strong>Investments</strong> 45,00,000 Current Assets 68,00,000 Loans and Advances 22,00,000 <PdfRef page={1} />
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
        ...
        <section id="as-21-accounting-standard-for-consolidated-46" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            FINANCIAL STATEMENTS Total Assets after revaluation 557 Less: 15% Debentures 180.0 Current Liabilities 100.0 (280) Equity / Net Worth 277 King Ltd.’s share of net assets (70% of 277) 193.9 King Ltd.’s cost of acquisition of shares of Queen Ltd. (`140 lakhs) (140) 8. Minority Interest = Equity attributable to minorities Equity is the residual interest in the assets of an enterprise after deducting all its liabilities i.e. in this case, it should be equal to Share Capital + Profit &amp; Loss A/c A = Share capital on 1.1.20X1 B = Profit &amp; loss account balance on 1.1.20X1 C = Share capital on 31.12.20X1 D = Profit &amp; loss account balance on 31.12.20X1 Minority % Shares Owned Minority interest as at the date of acquisition Minority interest as at the date of consolidation [E] [E] x [A + B] ` [E] X [C + D] ` Case A [100-90] 10 % 22,500 23,500 Case B [100-75] 25 % 50,000 40,000 Case C [100-70] 30 % 18,000 18,000 Case D [100-95] 5% 4,750 5,750 <PdfRef page={1} />
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
