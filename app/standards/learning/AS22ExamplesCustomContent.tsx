...
import {
  ...
  judicialCases,
  examCorner,
} from './AS22ExamplesData'

interface AS22ExamplesCustomContentProps {
...
export function AS22ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS22ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 22 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-300 leading-relaxed max-w-3xl">
          Learn Accounting for Taxes on Income under AS 22. Explore deferred tax liability on depreciation differences, deferred tax asset recognition under reasonable and virtual certainty, and offsetting rules.
        </p>
      </div>
