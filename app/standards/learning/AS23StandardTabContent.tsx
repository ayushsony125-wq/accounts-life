...
const PdfRef = ({ page }: { page: number }) => (
  ...
  return (
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      <div id="as23-standard-sticky-toc" className="sticky top-[58px] bg-white dark:bg-[#111726] border-b border-slate-200 dark:border-slate-800 z-20 w-full select-none shadow-sm">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
          <PdfRef page={1} /> Accounting Standard 23 prescribes the principles and procedures for recognizing **investments in associates** in Consolidated Financial Statements (CFS).
        </p>
        ...
        <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
          This standard should be applied in accounting for investments in associates in the consolidated financial statements of the investor. <PdfRef page={1} />
        </p>
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li><strong>Consolidated Accounts:</strong> Mandatory for all groups presenting CFS under AS 21. <PdfRef page={1} /></li>
          ...
          <table className="w-full text-[13.5px] border-collapse rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
                ...
                <td className="p-3 text-slate-700 dark:text-slate-300">An enterprise in which the investor has significant influence and which is neither a subsidiary nor a joint venture of the investor. <PdfRef page={2} /></td>
              </tr>
              ...
              <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10">
                ...
                <td className="p-3 text-slate-700 dark:text-slate-300">A method of accounting whereby the investment is initially recorded at cost, identifying any Goodwill/Capital Reserve. The carrying amount is adjusted thereafter for the post-acquisition changes in the investor\'s share of net assets of the investee. <PdfRef page={2} /></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
          <PdfRef page={2} /> Significant influence is presumed to exist if the investor holds, directly or indirectly through subsidiaries, **20% or more of the voting power** of the investee.
        </p>
        ...
        <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
          <PdfRef page={6} /> Under the equity method, the investment is initially recorded at cost in the investor\'s CFS.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li><strong>Revaluation/Reserve changes:</strong> Changes in the associate\'s reserves (e.g. revaluation reserves, capital reserves) are recognized directly in the consolidated reserves of the investor. <PdfRef page={7} /></li>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li><strong>Uniform Policies:</strong> The investor must ensure the associate uses uniform accounting policies for like transactions in similar circumstances. If not, adjustments must be made (unless impracticable). <PdfRef page={8} /></li>
        ...
        <ul className="list-disc pl-6 space-y-2 mb-4">
          <li><strong>Temporary Investment:</strong> The investment is not accounted for under the equity method if it is held exclusively with a view to its subsequent disposal in the near future (temporary associate). In this case, AS 13 applies. <PdfRef page={5} /></li>
        ...
        <div className="border border-slate-200 dark:border-gray-800 rounded-xl overflow-hidden mb-6">
          ...
          {openAccordions.disclosureItems && (
            <div className="p-4 bg-white dark:bg-[#111726] text-xs sm:text-[13px] space-y-2.5 leading-relaxed">
              ...
              <p>2. The investor\'s share of the profits/losses of such associates in the CFS. <PdfRef page={11} /></p>
