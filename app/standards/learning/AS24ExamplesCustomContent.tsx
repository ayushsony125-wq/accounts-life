...
import {
  ...
  judicialCases,
  examCorner,
} from './AS24ExamplesData'

interface AS24ExamplesCustomContentProps {
...
export function AS24ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS24ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 24 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Discontinuing Operations reporting under AS 24. Explore Initial Disclosure Event definitions, P&amp;L and Balance Sheet segregation formats, cash flow disclosures, and segment overlaps.
        </p>
      </div>
