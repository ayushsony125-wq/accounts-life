...
import {
  ...
  judicialCases,
  examCorner,
} from './AS26ExamplesData'

interface AS26ExamplesCustomContentProps {
...
export function AS26ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS26ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 26 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Intangible Assets accounting under AS 26. Explore research vs development phase criteria, internally generated brand bans, preliminary start-up expensing rules, and 10-year useful life guidelines.
        </p>
      </div>
