    ...
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <section id="as-26-introduction" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 2 --- v v v v 5.184 criteria are met. AS 26 also specifies how to measure the carrying amount of intangible assets and requires certain disclosures about intangible assets.</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-scope" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 3 --- v 5.185 v v v v 5.185 (iv) the underlying intangible asset in finance lease after its initial recognition.</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-identifiability" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            ...
            <li>-- PAGE 6 --- v v v v 5.188 only in combination with other assets, the asset is identifiable if the enterprise can identify the future economic benefits that will flow from the asset.</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-control" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 7 --- v 5.189 v v v v 5.189</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-internally-generated-goodwill" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 11 --- v 5.193 v v v v 5.193</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-research-phase" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 12 --- v v v v 5.194 c. The search for alternatives for materials, devices, products, processes, systems or services; d. The formulation, design, evaluation and final selection of possible alternatives for new or improved materials, devices, products, processes, systems or services.</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-subsequent-expenditure" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 17 --- v 5.199 v v v v 5.199</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-review-of-amortisation-period-and" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 21 --- v 5.203 v v v v 5.203</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
        ...
        <section id="as-26-disclosure" className="scroll-mt-36 space-y-6 w-full">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-[15px] font-sans text-slate-800 dark:text-slate-200">
            <li>-- PAGE 23 --- v 5.205 v v v v 5.205 (a) brand names; (b) mastheads and publishing titles; (c) computer software; (d) licences and franchises; (e) copyrights, and patents and other industrial property rights, service and operating rights; (f) recipes, formulae, models, designs and prototypes; and (g) intangible assets under development.</li>
          </ul>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 26**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
