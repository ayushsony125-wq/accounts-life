...
import {
  ...
  judicialCases,
  examCorner,
} from './AS27ExamplesData'

interface AS27ExamplesCustomContentProps {
...
export function AS27ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS27ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 27 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Financial Reporting of Interests in Joint Ventures under AS 27. Explore Jointly Controlled Operations (JCO), Jointly Controlled Assets (JCA), Jointly Controlled Entities (JCE), and proportionate consolidation rules.
        </p>
      </div>
