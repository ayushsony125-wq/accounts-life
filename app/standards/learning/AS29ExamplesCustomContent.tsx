...
import {
  ...
  judicialCases,
  examCorner,
} from './AS29ExamplesData'

interface AS29ExamplesCustomContentProps {
...
function CaseStudyCard({
  ...
  const themeMap = {
    ...
    rose: {
      accent: 'from-rose-500 via-rose-600 to-pink-605',
...
export function AS29ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS29ExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          AS 29 Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-350 leading-relaxed max-w-3xl">
          Learn Provisions, Contingent Liabilities and Contingent Assets under AS 29. Explore obligating events, warranty calculations, onerous contracts, restructuring plans, and notes disclosure parameters.
        </p>
      </div>
