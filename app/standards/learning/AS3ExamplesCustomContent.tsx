        ...
        <div className="flex items-center gap-2.5">
          ...
          {pdfPage && navigateToPdfPage && (
            <button
              ...
              className="inline-flex items-center gap-1 text-[10px] font-bold text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 bg-red-50 hover:bg-red-100/70 dark:bg-red-950/30 px-2 py-0.5 border border-red-200/40 dark:border-red-900/30 rounded cursor-pointer transition-all"
            >
              <FileText size={10} />
...
export function AS3ExamplesCustomContent({
  ...
  return (
    <div className="w-full space-y-6 animate-fade-in font-sans">
      ...
      {/* Static Exam Quick-Reference & Audit Summary Box */}
      <div className="bg-slate-50 dark:bg-[#181E30] border border-slate-200 dark:border-slate-800 rounded-xl p-6 sm:p-8 space-y-4">
        <h4 className="font-sans font-bold text-xs uppercase tracking-wider text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
          <Info size={14} />
          <span>AS 3 Cash Flow Direct vs Indirect Reference</span>
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[13px]">
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 font-mono">
            <span className="font-bold text-indigo-600 dark:text-indigo-400 block mb-2">Direct Method Outline (Para 18.1):</span>
            <p className="text-slate-500 font-bold mb-1">Cash Inflows &amp; Outflows directly listed:</p>
            <p>+ Cash receipts from Customers</p>
            <p>− Cash paid to Suppliers</p>
            <p>− Cash paid to Employees</p>
            <p>− Cash paid for Operating Expenses</p>
            <p>− Income Taxes Paid</p>
          </div>
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 font-mono">
            <span className="font-bold text-indigo-600 dark:text-indigo-400 block mb-2">Indirect Method Adjustments (Para 18.2):</span>
            <p className="text-slate-500 font-bold mb-1">Reconciles Net Profit to Cash Flow:</p>
            <p>Start: Net Profit Before Tax (NPBT)</p>
            <p>+ Non-Cash charges (Depreciation)</p>
            <p>+ Finance Costs (Interest Paid)</p>
            <p>+ Adjustments for current assets &amp; current liabilities</p>
            <p>− Income Taxes Paid</p>
          </div>
        </div>
      </div>
