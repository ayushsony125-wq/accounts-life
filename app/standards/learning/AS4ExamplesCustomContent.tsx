...
import {
  ...
  judicialCases,
  examCorner,
} from './AS4ExamplesData'

interface AS4ExamplesCustomContentProps {
...
export function AS4ExamplesCustomContent({
  navigateToPdfPage,
  renderTextWithReferences,
}: AS4ExamplesCustomContentProps) {
    ...
    <div className="w-full space-y-6 animate-fade-in font-sans">
      ...
      <div className="bg-slate-50 dark:bg-[#181E30] border border-slate-200 dark:border-slate-800 rounded-xl p-6 sm:p-8 space-y-4">
        <h4 className="font-sans font-bold text-xs uppercase tracking-wider text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
          <Info size={14} />
          <span>AS 4 Adjusting vs. Non-Adjusting Events Reference</span>
        </h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[13px] leading-relaxed">
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
            <span className="font-bold text-blue-600 dark:text-blue-400 block mb-2">Adjusting Events (Para 13):</span>
            <p className="text-slate-500 font-semibold mb-2">Conditions existed at year-end:</p>
            <ul className="list-disc pl-5 space-y-1 text-slate-650 dark:text-gray-400">
              <li>Debtor insolvency confirming year-end bad debts</li>
              <li>Settlement of court case confirming year-end liability</li>
              <li>Discovery of fraud or error revealing incorrect year-end accounts</li>
              <li>Going concern assumption becomes invalid ( Para 13 override)</li>
            </ul>
          </div>
          <div className="p-4 bg-white dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
            <span className="font-bold text-amber-600 dark:text-amber-400 block mb-2">Non-Adjusting Events (Para 14):</span>
            <p className="text-slate-500 font-semibold mb-2">Indicative of conditions arising *after* year-end:</p>
            <ul className="list-disc pl-5 space-y-1 text-slate-650 dark:text-gray-400">
              <li>Destruction of factory/inventory by fire/flood</li>
              <li>Major decline in market value of investments</li>
              <li>Proposed dividends (declared after year-end)</li>
              <li>Announcing plans to discontinue a business line</li>
            </ul>
          </div>
        </div>
      </div>
