    ...
    <div className="w-full animate-fade-in font-sans bg-[#F5F5F3] dark:bg-[#0B0F19] pb-8">
      ...
      <div className="max-w-[1720px] mx-auto w-[98%] px-3 sm:px-5 lg:px-8 mt-6">
        ...
        <section id="as-7-contract-revenue-and-costs" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            a8.9 Solution Total Revenue after considering the escalation costs, claims and incentives: ` Fixed Price: 5.00 crore Incentive for early completion 0.50 crore Material costs recovery (to the extent of 20%) 0.40 crore Labour costs recovery (Actual increase is less than 30%) 0.30 crore [1.20 crore x 25%] Total Contract Revenue 6.20 crore Add: Variation to the contract 1.00 crore Add: Claims recoverable from XY 0.20 crore Total Contract Revenue 7.40 crore (B) Contract costs should comprise: (i) costs that relate directly to the specific contract; (ii) costs that are attributable to contract activity in general and can be allocated to the contract; and (iii) such other costs as are specifically chargeable to the customer under the terms of the contract. NOTE: 1. Examples of costs that relate directly to a specific contract include: (a) site labour costs, including site supervision (b) costs of materials used in construction Contract Costs costs that relate directly to the specific contract; costs that are attributable to contract activity in general and can be allocated to the contract; other costs as are specifically chargeable to the customer under the terms of the contract. <PdfRef page={9} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
        ...
        <section id="as-7-disclosure" className="scroll-mt-36 space-y-6 w-full">
          ...
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            Actual cost incurred upto the reporting date (B) 2,093 6,068 (6,168-100) 8,200 (8,100+100) Degree of completion (B/A) 26% 74% 100% 10. Statement showing the amount of profit/loss to be taken to Profit and Loss Account and additional provision for the foreseeable loss as per <strong>AS 7</strong> Cost of Construction ` ` Material used 71,00,000 Labour Charges paid 36,00,000 Add: Outstanding on 31.03.20X2 2,00,000 38,00,000 Hire Charges of Plant 10,00,000 Other Contract cost incurred 15,00,000 Cost incurred upto 31.03.20X2 1,34,00,000 Add: Estimated future cost 33,50,000 Total Estimated cost of construction 1,67,50,000 Degree of completion (1,34,00,000/1,67,50,000 x 100) 80% Revenue recognized (80% of 1,50,00,000) 1,20,00,000 Total foreseeable loss (1,67,50,000 - 1,50,00,000) 17,50,000 Less: Loss for the current year (1,34,00,000 - 1,20,00,000) 14,00,000 Loss to be provided for 3,50,000 11. (a) Stage of completion = Costs incurred to date / Total estimated costs Year 1: 52.52 crore / 202 crore = 26% Year 2: (154.20 crore – 2.50 crore) / 205 crore = 74% Year 3: 205 crore / 205 crore = 100% (b) Profit for the year Year 1 Year 2 Year 3 Contract Revenue (1) 57.20 crore 109.30 crore 58.50 crore <PdfRef page={32} />
          </p>
          <p className="text-[16px] leading-relaxed text-slate-700 dark:text-slate-200 mb-4 font-serif">
            a8.33 (220 crore x 26%) (225 crore x 74% - 57.20 crore) (225 crore x 100% - 109.30 crore – 57.20 crore) Contract Cost (2) 52.52 crore 99.18 crore 53.30 crore (202 crore x 26%) (205 crore x 74% - 52.52 crore) (205 crore x 100% - 99.18 crore – 52.52 crore) Contract Profit (1) – (2) 4.68 crore 10.12 crore 5.20 crore 12. ` in lakhs Add: Estimated future cost 15.10 Percentage of completion till date to total estimated cost of construction = (32.50/47.60)  100 = 68.28% Proportion of total contract value recognised as revenue for the year ended 31st March, 20X2 per <strong>AS 7</strong> (Revised) = Contract price x percentage of completion = ` 45 lakh x 68.28% = ` 30.73 lakhs. (` in lakhs) Less: Total contract price (45.00) According to of <strong>AS 7</strong>, when it is probable that total contract costs will exceed total contract revenue, the expected loss should be recognized as an expense immediately. <PdfRef page={33} />
          </p>
          <NB type="exam" title="CA Final &amp; Intermediate Exam Tips">
            When preparing for exam questions on **AS 7**, pay close attention to disclosure requirements, classification boundary criteria, and exceptions to general valuation rules. Ensure that you reference specific paragraph numbers and compile-ready disclosure formats in your written drafts.
          </NB>
