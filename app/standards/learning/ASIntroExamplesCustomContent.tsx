...
import {
  ...
  judicialCases,
  examCorner,
} from './ASIntroExamplesData'

interface ASIntroExamplesCustomContentProps {
...
export function ASIntroExamplesCustomContent({
  navigateToPdfPage,
}: ASIntroExamplesCustomContentProps) {
    ...
    <div className="w-full font-sans space-y-6">
      ...
      <div className="p-6 bg-gradient-to-r from-[#1E2640] to-[#111726] rounded-2xl text-white shadow-xs">
        <h2 className="text-xl sm:text-2xl font-bold mb-2 flex items-center gap-2">
          ...
          Introduction to AS — Master Case Studies &amp; Examples
        </h2>
        <p className="text-[13px] sm:text-[14px] text-slate-300 leading-relaxed max-w-3xl">
          Deepen your understanding of Accounting Standards applicability limits, SMC vs MSME exemptions, transition requirements, and audit compliance issues through detailed illustrations and cases.
        </p>
      </div>
