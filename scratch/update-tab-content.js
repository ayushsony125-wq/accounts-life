...
const newFunctionContent = `function AS1StandardTabContent({ navigateToPdfPage, renderTextWithReferences }: AS1StandardTabContentProps) {
  ...
  return (
    <div className="w-full animate-fade-in font-sans bg-[#F8FAFC] dark:bg-[#070A10] -m-4 md:-m-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="sticky top-[58px] bg-white/95 dark:bg-[#0f1422]/95 backdrop-blur-md py-3 px-6 border-b border-slate-200 dark:border-slate-800/80 z-20 max-w-7xl mx-auto w-full select-none rounded-t-2xl shadow-md">
        <div className="flex flex-row flex-nowrap items-center justify-between gap-x-6 overflow-x-auto whitespace-nowrap [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <span className="font-serif text-slate-800 dark:text-slate-250 font-bold text-xs uppercase tracking-widest shrink-0 pr-4 border-r border-slate-200 dark:border-slate-800 flex items-center gap-2">
            <BookOpen size={13} className="text-amber-700 dark:text-amber-500" />
                ...
                <button
                  ...
                  className={\`transition-all hover:text-amber-700 dark:hover:text-amber-400 cursor-pointer py-1 \${
                    activeSection === sec.id
                      ? 'text-amber-700 dark:text-amber-455 font-extrabold border-b-2 border-amber-600 dark:border-amber-450'
      ...
      <div className="bg-white dark:bg-[#0f1422] shadow-2xl border-x border-b border-slate-200/80 dark:border-gray-800/85 rounded-b-2xl max-w-7xl mx-auto w-full p-8 sm:p-16 lg:p-20 space-y-20 relative">
        
        {/* Cover Document Header */}
        <div className="border-b-4 border-double border-amber-700/80 dark:border-amber-500/60 pb-10 mb-16 text-center select-none">
        ...
        <section id="as1-overview" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 1
            </div>
            <h2 className="text-2xl font-bold font-serif text-slate-900 dark:text-white tracking-tight leading-tight">
              Introduction &amp; Purpose of the Standard
            </h2>
            <div className="w-16 h-0.5 bg-amber-600 dark:bg-amber-500 mt-4"></div>
          </div>
          ...
          <div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden my-6 bg-slate-50/20 dark:bg-[#131a2c]/20 max-w-5xl">
            <div className="bg-slate-50 dark:bg-[#161f33] px-6 py-3.5 border-b border-slate-200 dark:border-slate-800">
              <h4 className="text-[11px] font-bold text-slate-800 dark:text-slate-200 uppercase tracking-widest font-mono">
          ...
          <div className="max-w-4xl space-y-5 font-serif text-[15px] text-slate-800 dark:text-slate-250 leading-relaxed">
            <p>
        ...
        <section id="as1-scope" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 2
            </div>
          ...
          <div className="max-w-4xl space-y-4 font-serif text-[15px] text-slate-800 dark:text-slate-250 leading-relaxed">
            <p>
          ...
          <div className="overflow-x-auto my-6 border border-slate-200 dark:border-slate-800 rounded-lg max-w-5xl">
          ...
          <div className="max-w-4xl font-serif text-[15px] text-slate-800 dark:text-slate-250 leading-relaxed">
            <p>
        ...
        <section id="as1-definition" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 3
            </div>
          ...
          <div className="overflow-x-auto my-6 border border-slate-200 dark:border-slate-800 rounded-lg max-w-5xl">
            <table className="w-full text-left border-collapse text-[13.5px]">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-850 font-serif text-slate-700 dark:text-slate-305">
                <tr>
          ...
          {/* Policies vs Estimates Table */}
          <div className="mt-8 space-y-3">
            <div className="text-slate-400 dark:text-gray-500 text-[10px] font-bold uppercase tracking-wider font-mono">Comparative Rationale: Policies vs. Estimates</div>
            <div className="overflow-x-auto border border-slate-200 dark:border-slate-800 rounded-lg max-w-5xl">
              <table className="w-full text-left border-collapse text-[13.5px]">
                <thead>
                  <tr className="bg-slate-50 dark:bg-[#161f33] border-b border-slate-200 dark:border-slate-850 font-mono">
          ...
          <div className="max-w-4xl mt-4 font-serif text-[15px] text-slate-800 dark:text-slate-250 leading-relaxed">
            <p>
        ...
        <section id="as1-areas" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 4
            </div>
            <h2 className="text-2xl font-bold font-serif text-slate-900 dark:text-white tracking-tight leading-tight">
              Key Areas of Diversity in Accounting Policies
            </h2>
            <div className="w-16 h-0.5 bg-amber-600 dark:bg-amber-500 mt-4"></div>
          </div>
          ...
          <div className="space-y-8 max-w-5xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                {/* 1. Depreciation */}
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.1</span>
                      <span>Depreciation, Depletion, and Amortisation</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.2</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.3</span>
                      <span>Goodwill &amp; Intangible Assets</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.4</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.7</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.12</span>
                      <span>Patents, Trademarks, and Franchise Rights</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.6</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.10</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.11</span>
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.13</span>
                ...
                {/* 15. Expenditure during Construction */}
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.15</span>
                      <span>Expenditure during Construction</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-705 dark:text-[#E2E8F0] leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.5</span>
                      <span>Retirement &amp; Employee Benefits</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.8</span>
                      <span>Contingent Liabilities &amp; Provisions</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
                ...
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.9</span>
                      <span>Foreign Currency Translation</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
                ...
                {/* 14. Leases & Hire Purchase */}
                <details className="group border border-slate-200/80 dark:border-slate-800 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 hover:border-slate-350 dark:hover:border-slate-700 transition-colors">
                  <summary className="font-serif font-bold text-slate-900 dark:text-white cursor-pointer hover:text-amber-705 dark:hover:text-amber-405 flex items-center justify-between p-4 select-none list-none text-[14.5px] sm:text-base [&::-webkit-details-marker]:hidden">
                    <span className="flex items-center gap-3">
                      <span className="text-amber-700 dark:text-amber-500 font-mono text-xs font-bold bg-amber-50 dark:bg-amber-955 px-2 py-0.5 rounded">4.14</span>
                      <span>Leases &amp; Hire-Purchase</span>
                    </span>
                    <ChevronDown size={14} className="transform group-open:rotate-180 transition-transform text-slate-400" />
                  </summary>
                  <div className="border-t border-slate-200/80 dark:border-slate-800 p-4 text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed bg-white dark:bg-[#111726] rounded-b-lg font-serif">
        ...
        <section id="as1-selection" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 5
            </div>
        ...
        {/* Section 5A: Prudence */}
        <section id="as1-prudence" className="scroll-mt-36 space-y-6">
        ...
        <section id="as1-substance" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 5B
            </div>
        ...
        <section id="as1-materiality" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 5C
            </div>
          ...
          <div className="my-6 border border-slate-200 dark:border-slate-800 rounded-lg overflow-x-auto max-w-5xl">
            <table className="w-full text-left border-collapse text-[13.5px]">
              <thead>
                <tr className="bg-slate-50 dark:bg-[#161f33] border-b border-slate-200 dark:border-slate-850 font-mono">
        ...
        <section id="as1-assumptions" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 6
            </div>
        ...
        <section id="as1-going-concern" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 6A
            </div>
        ...
        <section id="as1-consistency" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 6B
            </div>
        ...
        {/* Section 6C: Accrual */}
        <section id="as1-accrual" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 6C
            </div>
        ...
        <section id="as1-disclosure" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 7
            </div>
          ...
          {/* Manner of Disclosure Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6 max-w-5xl">
            <div className="border border-slate-200 dark:border-slate-800 p-6 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 space-y-2">
              <span className="text-amber-700 dark:text-amber-500 font-mono text-[10px] font-bold uppercase tracking-wider">Requirement 01</span>
              <h4 className="font-serif font-bold text-[15px] text-slate-900 dark:text-white">Significant Policies</h4>
              <p className="text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed font-serif">
            ...
            <div className="border border-slate-200 dark:border-slate-800 p-6 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 space-y-2">
              <span className="text-amber-700 dark:text-amber-500 font-mono text-[10px] font-bold uppercase tracking-wider">Requirement 02</span>
              <h4 className="font-serif font-bold text-[15px] text-slate-900 dark:text-white">Integral Component</h4>
              <p className="text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed font-serif">
            ...
            <div className="border border-slate-200 dark:border-slate-800 p-6 rounded-lg bg-slate-50/10 dark:bg-slate-900/5 space-y-2">
              <span className="text-amber-700 dark:text-amber-500 font-mono text-[10px] font-bold uppercase tracking-wider">Requirement 03</span>
              <h4 className="font-serif font-bold text-[15px] text-slate-900 dark:text-white">Presented in One Place</h4>
              <p className="text-[13.5px] text-slate-700 dark:text-slate-300 leading-relaxed font-serif">
                All disclosures should normally be presented together in a single place (Note 1) to facilitate reading and prevent scattered disclosures that could be overlooked. <PdfRef page={7} />
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="as1-change-policy" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 8
            </div>
          ...
          <div className="space-y-6 my-8 pl-4 border-l-2 border-slate-100 dark:border-slate-800 max-w-4xl">
            <div className="relative pl-6">
              <div className="absolute -left-[25px] top-1 w-2.5 h-2.5 rounded-full border border-amber-600 bg-white dark:bg-[#0f1422]"></div>
        ...
        <section id="as1-para23" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-3 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-sm tracking-wider mb-1 font-semibold uppercase">
              Sub-chapter 8A
            </div>
          ...
          <div className="border border-amber-600/30 dark:border-amber-500/25 bg-amber-50/5 dark:bg-amber-955/5 p-6 rounded-lg my-8 max-w-4xl space-y-4">
            <div className="flex items-center gap-2 text-amber-805 dark:text-amber-400 font-mono text-[11px] font-bold uppercase tracking-widest">
              <Scale size={14} className="text-amber-700 dark:text-amber-500" />
              Critical Legal Precedent — Paragraph 23
            </div>
            <blockquote className="border-l-2 border-amber-500 pl-4 py-1 italic font-serif text-[16px] text-slate-900 dark:text-slate-100 font-medium leading-relaxed">
        ...
        <section id="as1-footnotes" className="scroll-mt-36 space-y-6">
          <div className="border-b border-slate-200/80 dark:border-slate-800 pb-4 mb-6">
            <div className="text-amber-700 dark:text-amber-500 font-serif italic text-xs tracking-widest mb-1.5 font-bold uppercase">
              Chapter 9
            </div>
            <h2 className="text-2xl font-bold font-serif text-slate-900 dark:text-white tracking-tight leading-tight">
              Statutory Footnotes &amp; Scope Limits
            </h2>
            <div className="w-16 h-0.5 bg-amber-600 dark:bg-amber-500 mt-4"></div>
          </div>
...
console.log('Successfully replaced AS1StandardTabContent in LearningPortalClient.tsx!');
